...
var appRoutes = [
    ...
    { path: 'not-found', component: _not_found_not_found_component__WEBPACK_IMPORTED_MODULE_28__["NotFoundComponent"] },
...
var CartComponent = /** @class */ (function () {
    ...
    function CartComponent(auth, worker, order, router) {
        ...
        this.displayedColumns = ['idOrder', 'name', 'orderStatus', 'orderDate', 'choose'];
        this.displayedColumns2 = ['idOrder', 'name', 'orderStatus', 'orderDate'];
    }
...
var OrderPendingComponent = /** @class */ (function () {
    ...
    function OrderPendingComponent(order, auth, worker) {
        ...
        this.Orders = [];
        // We define in which order we will display the column
        this.displayedColumns = ['idOrder', 'name', 'orderDate', 'choose'];
        this.displayedColumns2 = ['idOrder', 'name', 'orderDate'];
    }
    // ngOnInit() is the function that will be executed at the start of the script
...
/* harmony import */ var _order_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../order.service */ "./src/order.service.ts");
...
var ProfileComponent = /** @class */ (function () {
    function ProfileComponent(auth, dialog, order, router) {
        this.auth = auth;
        this.dialog = dialog;
        this.order = order;
        this.router = router;
    ...
    ProfileComponent.prototype.ngOnInit = function () {
        ...
        this.auth.profile().subscribe(function (user) {
            ...
            _this.GetReviewCount(user.id);
            _this.GetOrderCount(user.id);
        }, function (err) {
            console.error((err));
        });
    };
    ...
    ProfileComponent.prototype.GetReviewCount = function (idUser) {
        var _this = this;
        this.auth.getReviewCount(idUser).subscribe(function (review) {
            _this.reviewCount = review.count;
        });
    };
    ProfileComponent.prototype.GetOrderCount = function (idUser) {
        var _this = this;
        this.order.getOrderCount(idUser).subscribe(function (order) {
            _this.orderCount = order.count;
        });
    };
    ...
    ProfileComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_authentification_service__WEBPACK_IMPORTED_MODULE_2__["AuthentificationService"], _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatDialog"], _order_service__WEBPACK_IMPORTED_MODULE_5__["OrderService"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"]])
    ], ProfileComponent);
...
var WorkerProfileComponent = /** @class */ (function () {
    function WorkerProfileComponent(auth, order, user, dialog, router) {
        this.auth = auth;
        this.order = order;
        this.user = user;
        this.dialog = dialog;
...
var AuthentificationService = /** @class */ (function () {
    ...
    AuthentificationService.prototype.getReviewCount = function (idUser) {
...
var OrderService = /** @class */ (function () {
    ...
    OrderService.prototype.getOrderCount = function (idWorker) {
